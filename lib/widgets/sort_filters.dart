...
import 'package:vreceipt_customer/models/category.dart'; // Import the categories
...
class _SortFilterMenuState extends State<SortFilterMenu> {
  ...
  void _resetFilters() {
    setState(() {
      totalPriceMin = 0.00;
      totalPriceMax = 99999999999.00;
      productPriceMin = 0.00;
      productPriceMax = 999999999999.00;
      category = '';
      startDate = null;
      endDate = null;
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              foregroundColor: sortBy == 'Name of Shop'
                                  ? Colors.lightBlue
                                  : (isDarkMode ? Colors.white : Colors.black),
                              backgroundColor: sortBy == 'Name of Shop'
                                  ? Colors.lightBlue[100]
                                  : (isDarkMode
                                      ? Colors.grey[800]
                                      : Colors.white),
                            ),
                            child: const Text('Name of Shop'),
                          ),
                        ),
                        const SizedBox(width: 10),
                        Expanded(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          activeColor:
                              Colors.lightBlue, // Adjust color for dark mode
                        ),
