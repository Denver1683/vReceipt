...
class UnblockMerchantScreen extends StatefulWidget {
  const UnblockMerchantScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _UnblockMerchantScreenState createState() => _UnblockMerchantScreenState();
}

class _UnblockMerchantScreenState extends State<UnblockMerchantScreen> {
  String searchQuery = "";
            ...
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                if (filteredDocs.isEmpty) {
                  return const Center(child: Text('No merchant is unblocked.'));
                }
